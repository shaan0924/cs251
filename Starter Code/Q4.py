...
def coinExchangeScript(public_key_sender, public_key_recipient, hash_of_secret):
    return [
        OP_DUP, OP_HASH160, hash_of_secret, OP_EQUAL, OP_IF, OP_DROP, public_key_sender, OP_CHECKSIG, OP_ELSE, public_key_recipient, OP_CHECKSIGVERIFY, public_key_sender, OP_CHECKSIG, OP_ENDIF
    ]
