...
my_private_key = CBitcoinSecret(
    'cVD95BUeKWRxtGgrdwXxtGuueo44Tq94MLCWe2Dz42Bbun4D7AVU' )
...
alice_secret_key_BTC = CBitcoinSecret(
    'cUD4CxzTXv9QHftZc5rcRfSCvkpoDDXbu7c87ymm26HS566AnE3o')

# Only to be imported by bob.py
bob_secret_key_BTC = CBitcoinSecret(
    'cSLzkhwDMgdV8pTv9yqyrS45fbDhTh1SX72MZuGHC6x52GTJgJjk')
...
alice_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('faa3955270ac159e86b8783258f815a6dd323b5763e42e75860fdf64a912a526'))

# Only to be imported by bob.py
# Bob should have coins!!
bob_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('c589ef4215dbaaf45b49c835c3c78d05c611b41cd8625b7169ea6ddafa5dcc0a'))

# Can be imported by alice.py or bob.py
alice_public_key_BCY = alice_secret_key_BCY.pub
alice_address_BCY = P2PKHBitcoinAddress.from_pubkey(alice_public_key_BCY)
#print('C2cD5c8WUn7zYd9ZpvPjFnSvdcguhcvByd')
